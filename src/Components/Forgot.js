      ...
      <dir className="din">
        <div className="flex flex-row flex-wrap justify-center">
          ...
          <form
            ...
            className="m-10 w-50 flex flex-col rounded-lg border-2 border-red-300 text-center flex-wrap bg-gray-200 p-2 loginClass"
          >
            <div style={errStyle} className="text-red-600 text-2xl text-center bg-gray-100">{error}</div>
            <div className="text-2xl m-2 loginClass text-gray-500">Forgot Password</div>
            ...
            <div className="loginClass">
              <button
                type="submit" className="text-2xl text-gray-800 px-2 py-1 rounded-lg m-4 border-2 border-sky-400 hover:bg-sky-200 loginClass"
                disabled={loading}
              >
                Reset Password
              </button>
