      ...
      <div className="din">
        <div className="flex flex-row flex-wrap justify-center ">
          ...
          >
            ...
            <div className="text-3xl m-1 loginClass text-gray-500">Signup</div>
            ...
            <div className="loginClass">
              <button
                type="submit"
                class="text-2xl text-gray-800 px-3 py-2 rounded-lg m-4 border-2 border-blue-400 hover:bg-blue-200 loginClass" disabled={loading}
              >
                signup
              </button>
            </div>
